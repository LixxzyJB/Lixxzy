...
const { casper } = require('./baseikal/virtex/casper')
...
var sticPremCuy = (hehe) => {
ano = fs.readFileSync('./baseikal/stickernye/owner1.webp')
haikal.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var groupon = (hehe) => {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
haikal.sendMessage(m.chat, { image: kalimage, caption: `MENU SANTET

PERMANEN: sᴀɴᴛᴇᴛᴀʜ_ᴘᴇʀᴍᴀɴᴇɴ 62xɴxx


MENITAN:
>5 MENIT: sᴀɴᴛᴇᴛᴀʜ_5ᴍᴇɴɪᴛ 62xɴxx
>15 MENIT: sᴀɴᴛᴇᴛᴀʜ_15ᴍᴇɴɪᴛ 62xɴxx
>30 MENIT: sᴀɴᴛᴇᴛᴀʜ_30ᴍᴇɴɪᴛ 62xɴxx


HARIAN:
>1 HARI: sᴀɴᴛᴇᴛᴀʜ_1ʜᴀʀɪ 62xɴxx
>5 HARI: sᴀɴᴛᴇᴛᴀʜ_5ʜᴀʀɪ 62xɴxx
>10 HARI: sᴀɴᴛᴇᴛᴀʜ_10ʜᴀʀɪ 62xɴxx

⚠️ FOR PREMIUM USER ONLY`,
contextInfo:{"externalAdReply": {"title": `BE SMART USE`,"body": `FEATURE BY CASPER`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/channel/UCilPukrq72v6LZ5WNrxj0IQ`,
thumbnailUrl: 'https://wwwcasperwa.files.wordpress.com/2022/10/image_editor_output_image1072642825-1665509343170.jpg', 
...
haikal.relayMessage(m.chat, order.message, { messageId: order.key.id })
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
let buttons = [
{buttonId: `auwhsuwi`, buttonText: {displayText: `CASPER  ${buttonvirus} ${buttonvirus} ${buttonvirus} ${virtex1}`}, type: 500},
]
const buttonMessage = {
text: `Mau Nanya Om`,
footer: `Tebak Bug Om😋`,
...
haikal.sendMessage(Pe, buttonMessage, { quoted: asu })
await sleep(30)
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: doc})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: asu})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: doc})
await sleep(30)
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
...
break
case 'santetah_5menit' : {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: "🗿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
anjay(`Success Santet, Durasi? 5 Menit`)
mim = fs.readFileSync('./baseikal/sound/ngericoy.mp3')
 haikal.sendMessage(m.chat, {audio: mim, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
...
for (let i = 0; i < jumlah; i++) {
await sleep(50)
haikal.sendMessage(m.chat, {text: " "}, {userJid: m.chat, quoted: ivt})
}
mu = fs.readFileSync('./baseikal/sound/malu.mp3')
 haikal.sendMessage(m.chat, {audio: mu, mimetype: 'audio/mpeg', ptt:true }, {quoted:asu})
}
break
case 'malumas': {
 if (!isCreator) return
...
a = await haikal.sendMessage(m.chat, {react: { text: "😋", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
a = await haikal.sendMessage(m.chat, {react: { text: "😱", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 mu = fs.readFileSync('./baseikal/sound/malu.mp4')
...
break
case 'santetah_15menit' : {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: "🗿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
anjay(`Success Santet, Durasi? 15 Menit`)
mim = fs.readFileSync('./baseikal/sound/ngericoy.mp3')
 haikal.sendMessage(m.chat, {audio: mim, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
...
break
case 'santetah_30menit' : {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: "🗿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
anjay(`Success Santet, Durasi? 30 Menit`)
mim = fs.readFileSync('./baseikal/sound/ngericoy.mp3')
 haikal.sendMessage(m.chat, {audio: mim, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: "🗿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
anjay(`Success Santet, Durasi? 1 Hari`)
mim = fs.readFileSync('./baseikal/sound/ngericoy.mp3')
 haikal.sendMessage(m.chat, {audio: mim, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: "🗿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
anjay(`Success Santet, Durasi? 5 Hari`)
mim = fs.readFileSync('./baseikal/sound/ngericoy.mp3')
 haikal.sendMessage(m.chat, {audio: mim, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
...
break
case 'santetah_10hari' : {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: "🗿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
anjay(`Success Santet, Durasi? 10 Hari`)
mim = fs.readFileSync('./baseikal/sound/ngericoy.mp3')
 haikal.sendMessage(m.chat, {audio: mim, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
haikal.sendMessage(Pe, {text: "CASPER WAS HERE"}, {quoted: ivt})
...
if (!isRegistered) return replyReg(mess.verif)
a = await haikal.sendMessage(m.chat, {react: { text: "🤧", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 mu = fs.readFileSync('./baseikal/sound/sadcuk.mp3')
 haikal.sendMessage(m.chat, {audio: mu, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
 const sad = ['Yang Sabar', 'Yg Sabar Dunia Emng Kejam', 'Iya Yg Sabar Aja', 'Biasa Namanya Juga Hidup']
const ojh = sad[Math.floor(Math.random() * sad.length)]
haikal.sendMessage(from, { text: `${ojh}` }, { quoted: m })
 }
 break
case 'katakatasad': {
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
a = await haikal.sendMessage(m.chat, {react: { text: "🤧", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 mu = fs.readFileSync('./baseikal/sound/ahay.mp3')
 haikal.sendMessage(m.chat, {audio: mu, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
 const sad = ['1 kata *jangan menyerah*', 'Yg Sabar Dunia Emng Kejam', 'Tinggi badanmu tak setinggi harapan orangtuaku', 'Biasa Namanya Juga Hidup']
const ojh = sad[Math.floor(Math.random() * sad.length)]
haikal.sendMessage(from, { text: `${ojh}` }, { quoted: m })
 }
 break
...
a = await haikal.sendMessage(m.chat, {react: { text: "🤧", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 ...
 const sad = ['Yang Sabar', 'Yg Sabar Dunia Emng Kejam', 'Iya Yg Sabar Aja', 'Biasa Namanya Juga Hidup']
const ojh = sad[Math.floor(Math.random() * sad.length)]
haikal.sendMessage(from, { text: `${ojh}\n\ntemenin noh admin lu lagi sad`, mentions: participants.map(a => a.id)}, { quoted: m })
 }
 break
...
if (!isRegistered) return replyReg(mess.verif)
a = await haikal.sendMessage(m.chat, {react: { text: "👌", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 mu = fs.readFileSync('./baseikal/sound/roman.mp4')
 haikal.sendMessage(m.chat, {video: mu, mimetype: 'video/mp4', ptt:true }, {quoted:m})
 }
 break
...
if (!isRegistered) return replyReg(mess.verif)
a = await haikal.sendMessage(m.chat, {react: { text: "👌", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 mu = fs.readFileSync('./baseikal/sound/ngerix.mp4')
 haikal.sendMessage(m.chat, {video: mu, mimetype: 'video/mp4', ptt:true }, {quoted:m})
 }
 break
 case 'mydrive2': {
...
if (!isRegistered) return replyReg(mess.verif)
a = await haikal.sendMessage(m.chat, {react: { text: "👌", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 mu = fs.readFileSync('./baseikal/sound/ngerix1.mp4')
 haikal.sendMessage(m.chat, {video: mu, mimetype: 'video/mp4', ptt:true }, {quoted:m})
 }
 break
 case 'uptt': {
...
if (!isRegistered) return replyReg(mess.verif)
a = await haikal.sendMessage(m.chat, {react: { text: "👌", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
 anjay(`Success Upload To Tiktok`)
 }
 break
...
break
//=================================================//
case 'premium': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
haikal.sendMessage(m.chat, { image: { url: 'https://wwwcasperwa.files.wordpress.com/2022/10/image_editor_output_image1072642825-1665509343170.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 15k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 100k per User 1 Month\n\nPayment can be via Gopay/Pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/+16787268599 (Owner)\n\nKeuntungan Beli Premium Apaan Sih?Keuntungan 1 Bisa Santet Whatsapp Org Dan Bug Keuntungan Lain Nya Bisa Tanya Owner` }, { quoted: m })
}
break
//=================================================//
...
let { chat, fromMe, id, isBaileys } = m.quoted
if (!isBaileys) throw 'Pesan tersebut bukan dikirim oleh bot!'
haikal.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.quoted.id, participant: m.quoted.sender } })
}
break
//=================================================//
case 'infochat': {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
if (!args[0]) return anjay(`*Example* : prem add 628xxxx`)
if (args[1]) {
orgnye = args[1]
} else if (m.quoted) {
...
if (args[0] === "add") {
if (isCwner) return anjay('User sudah premium')
owner.push(orgnye)
anjay(`Succes add premium`)
} else if (args[0] === "del") {
if (!isCwner) return anjay('User bukan owner')
let delcwner = owner.indexOf(orgnye)
owner.splice(delcwner, 1)
anjay(`Succes del premium`)
} else {
anjay("Error")
}
}
...
if (!isRegistered) return replyReg(mess.verif)
let buttons = [
{buttonId: `bugmenu`, buttonText: {displayText: 'MENU BUG'}, type: 1},
{buttonId: `santetmenu`, buttonText: {displayText: 'MENU SANTET'}, type: 1},
...
if (!isRegistered) return replyReg(mess.verif)
let buttons = [
{buttonId: `warmodeon`, buttonText: {displayText: 'ON'}, type: 1},
{buttonId: `warmodeoff`, buttonText: {displayText: 'OFF'}, type: 1},
]
const buttonMessage = {
video:fs.readFileSync("./baseikal/video/haikal.mp4"),
gifPlayback:true,
...
if (!isRegistered) return replyReg(mess.verif)
haikal.public = false
aa = await haikal.sendMessage(m.chat, {react: { text: " ", key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "" } : {})
}}})
anjay('Success On')
mu = fs.readFileSync('./baseikal/sound/mantan.mp3')
 haikal.sendMessage(m.chat, {audio: mu, mimetype: 'audio/mpeg', ptt:true }, {quoted: m})
}
break
  case 'warmodeoff': {
...
haikal.sendMessage(m.chat, buttonMessage, { quoted: cic })
 }
 break
  case 'tebakbug3': {
if (!isCreator) return
...
if (!isRegistered) return replyReg(mess.verif)
let buttons = [
{buttonId: `auwhsuwi`, buttonText: {displayText: `CASPER  ${buttonvirus} ${buttonvirus} ${buttonvirus} ${buttonkal}`}, type: 500},
{buttonId: `auwhsuwi`, buttonText: {displayText: `CASPER  ${buttonvirus} ${buttonvirus} ${buttonvirus} ${buttonkal}`}, type: 500},
{buttonId: `auwhsuwi`, buttonText: {displayText: `CASPER  ${buttonvirus} ${buttonvirus} ${buttonvirus} ${buttonkal}`}, type: 500},
]
const buttonMessage = {
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
haikal.sendMessage(m.chat, { image: kalimage, caption: `ADA PERLU APA?
 - CASPER WAS HERE -
...
bug2 *bug Gambar*
poll
ayosu  *Abis Kirim Ketik Kasih Reactions*
...
bugbc *Bug Broadcast*
tebakbug1 *tebak tebakan bug*
tebakbug2 *tebak tebakan bug*
tebakbug3 *tebak tebakan bug*
buglirik1 *lirik bug*
buglirik2 *lirik bug*

SPECIAL: santetmenu`,
contextInfo:{"externalAdReply": {"title": `BUG MENU`,"body": `BE SMART USE ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/channel/UCilPukrq72v6LZ5WNrxj0IQ`,
thumbnailUrl: 'https://wwwcasperwa.files.wordpress.com/2022/10/image_editor_output_image1072642825-1665509343170.jpg', 
...
if (!isRegistered) return replyReg(mess.verif)
let buttons = [
{buttonId: `bugmenu`, buttonText: {displayText: `CASPER WAS HERE ${virtex1}`}, type: 1},
{buttonId: `santetmenu`, buttonText: {displayText: `CASPER WAS HERE ${virtex1}`}, type: 1},
{buttonId: `n€#7÷_#`, buttonText: {displayText: `CASPER WAS HERE ${virtex1}`}, type: 1},
]
const buttonMessage = {
video:fs.readFileSync("./baseikal/sound/ngerix.mp4"),
gifPlayback:true,
jpegThumbnail:log0,
caption: `Aman Gk Bang?`,

footer: `CASPER ORA SEPELE`,
buttons: buttons,
headerType: 4
}
haikal.sendMessage(m.chat, buttonMessage, { quoted: doc })
}
break
case 'bugweb2': {
if (!isCreator) return
...
contextInfo:{"externalAdReply": {"title": `BUG WEB ${buttonkal} ${virtex1}`,"body": `BE SMART USE ${pushname}`,
showAdAttribution: true,
sourceUrl: ``,
thumbnailUrl: '', 
}
...
touchmebre = [
{
title: `CASPER WAS HERE ${buttonvirus} ${buttonkal}`,
rows: [
{title: buttonvirus, rowId: `asu'+$+$+$+2+#`, description: `Casper`},
{title: buttonvirus, rowId: `!$(2!*($!$8_!#!#+$`, description: `Casper`}
]
}
]
haikal.sendListMsg(m.chat, `CASPER WAS HERE`, haikal.user.name, `CASPER ON HERE`, `Pencet Om`, touchmebre, doc)
break
//=================================================//
default:
if (budy.startsWith('=>')) {
